...
<?php include 'topbar.php';?>
                ...
                <div class="container-fluid">
                  ...
                  <div class="card-header px-4 py-3">
                    <h3 class="mb-0">Agregar nueva familia</h3>
                  </div>
                  ...
                  <input type="hidden" name="id" id="id" value="<?php echo $id;?>">       
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="familia" name="familia" placeholder="Introduce familia" value=""   autocomplete="new-text">
                        </div>
                      </div>
  ...
  <script>
    ...
    $("#volver").click(function() {
        window.location.href = 'familias_list.php';
    });
